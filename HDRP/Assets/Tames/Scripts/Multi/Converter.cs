...
namespace Multi
{
    public class Converter
    {
        ...
        /// number which uses the high bit, rendering compression via <see cref="WebMessage.AddVarULong(ulong)"/> and <see cref="WebMessage.GetVarULong"/> ineffective.</remarks>
