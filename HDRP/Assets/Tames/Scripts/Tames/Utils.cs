...
/// Three of them (Update, Slide and Rotate) also indicate the effects of a <see cref="Updater"/>.
/// </summary>
...
public class TrackBasis
{
    ...
    public const ushort Head = 2;
    public const ushort Time = 4;
    public const ushort Object = 8;
    public const ushort Tame = 16;
    public const ushort Grip = 32;
    public const ushort Mover = 64;
    public const ushort Manual = 128;
    public const ushort Alter = 256;
    public const ushort Switch = 512;
    public const ushort Distance = 1024;
