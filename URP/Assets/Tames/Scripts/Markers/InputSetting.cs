...
namespace Markers
{
    ...
    public class InputSetting
    {
        ...
        private ControlType type = ControlType.Mono;
        ...
        public int CheckDualPressed(GameObject g, bool multi = true)
        {
            int d;
            if (CoreTame.multiPlayer && multi)
            {
            ...
            {
                bool possible = true;
                if (TameCamera.CheckDistanceAndAngle(g, maxDistance, maxAngle, axis))
                {
        ...
        public int CheckDualHeld(GameObject g, bool multi = true)
        {
            int dp, dir = 0;
