...
namespace Tames
{
    ...
    public class TameFinder
    {
        ...
        /// </summary>
        public ushort trackMode = TrackBasis.Tame;
        /// <summary>
        ...
        /// ~X..Y: Regardless of what relation X has with Y, the ~ indicates that once an X is found, the rotation of it will affect the <see cref="owner"/>'s change not its sliding. In it's absence, the sliding or update would affect the latter (See <see cref="Updater.effect"/> and <see cref="Updater.input"/>).
        /// </summary>
        /// <param name="s"></param>
        /// <param name="s2"></param>
        /// <returns></returns>
